...
final class FfiResultList_Entry extends ffi.Opaque {}

final class FfiResultList_KeyEntry extends ffi.Opaque {}

final class FfiResultList_String extends ffi.Opaque {}

final class LocalKey extends ffi.Opaque {}

final class Option_EnabledCallback extends ffi.Opaque {}

final class Option_FlushCallback extends ffi.Opaque {}

final class SecretBuffer extends ffi.Struct {
  @ffi.Int64()
  external int len;
...
final class ArcHandle_FfiEntryList extends ffi.Struct {
  external ffi.Pointer<FfiEntryList> _0;
}

typedef FfiEntryList = FfiResultList_Entry;

final class ArcHandle_LocalKey extends ffi.Struct {
...
final class EncryptedBuffer extends ffi.Struct {
...
final class AeadParams extends ffi.Struct {
  @ffi.Int32()
...
final class ArcHandle_FfiKeyEntryList extends ffi.Struct {
  external ffi.Pointer<FfiKeyEntryList> _0;
}

typedef FfiKeyEntryList = FfiResultList_KeyEntry;

final class ArcHandle_FfiStringList extends ffi.Struct {
